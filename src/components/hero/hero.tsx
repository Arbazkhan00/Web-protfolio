            ...
            <section className="  bg-slate-100">
                ...
                <div className="flex  flex-col md:flex-row items-center ">
                    <div className="flex-1">
                        ...
                        <p className="mt-4 text-slate-500">Currently im doing Bachelor of Science inartificial intelligence From Iqra University and also doing Metaverse Course from PIAIC</p>
